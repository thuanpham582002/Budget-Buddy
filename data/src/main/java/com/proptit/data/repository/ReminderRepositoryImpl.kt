...
import com.proptit.data.mapper.ReminderMapper
...
class ReminderRepositoryImpl @Inject constructor(
    ...
    override suspend fun getReminderById(id: Int, userId: Int): Reminder {
        return withContext(Dispatchers.IO) {
            ReminderMapper.toReminder(reminderDao.getReminderById(id, userId))
        }
    }

    override fun getAllReminders(userId: Int): Flow<List<Reminder>> {
        return reminderDao.getAllReminder(userId).map { allReminders ->
