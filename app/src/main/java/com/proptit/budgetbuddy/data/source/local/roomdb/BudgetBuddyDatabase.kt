...
import com.proptit.budgetbuddy.data.source.local.roomdb.converter.TimeConverter
...
@Database(
    entities = [UserEntity::class, CategoryEntity::class, BudgetEntity::class,ReminderEntity::class],
    version = 1
)
@TypeConverters(DateConverter::class, CategoryTypeConverter::class, TimeConverter::class, BudgetTypeConverter::class)
