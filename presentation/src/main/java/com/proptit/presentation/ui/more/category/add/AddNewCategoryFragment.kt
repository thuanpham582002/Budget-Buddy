...
import com.proptit.presentation.databinding.FragmentAddNewCategoryBinding
import com.proptit.presentation.ui.more.category.CategoryIconAdapter
    ...
    private fun initBehavior() {
        ...
        binding.imageViewDone.setOnClickListener {
            ...
            if (categoryName.isEmpty()) {
                binding.editTextCategoryName.error =
                    getString(commonR.string.please_enter_category_name)
            } else {
                val type = arguments?.getInt(Constant.CATEGORY_TYPE)!!
